...
CLASS HMenuItem INHERIT HControl
...
METHOD new ( oParent, cOption, bAction, cToolTip, cStatusTip, cWhatsThis, cStyleSheet, lSeparator, nId, cBitmap) CLASS HMenuItem
   ...
   IF !lSeparator
      ...
      ELSE
        ...
        ::oQt := HFILO():last():oQt:addAction(cOption)
      ENDIF
   ...
   ELSE
      ...
      ELSE
        ...
        ::oQt := HFILO():last():oQt:addSeparator()
      ENDIF
