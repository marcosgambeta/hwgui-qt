...
PROCEDURE Main ()
   ...
   BEGIN MENUBAR oMenuBar OF oMainWindow
      ...
      END MENU
      BEGIN MENU oMenu2 TITLE "Menu &2" INVISIBLE
   ...
   @ 30,30 BUTTON oButton1 CAPTION "Menu Visible" SIZE 120,40 ON CLICK oMenu2:lVisible := .T.

   @ 30,70 BUTTON oButton2 CAPTION "Menu Invisible" SIZE 120,40 ON CLICK oMenu2:lVisible := .F.
