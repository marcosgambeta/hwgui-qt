...
STATIC FUNCTION ChildWindow1 (oParent)
   ...
   INIT WINDOW oWindow MDICHILD TITLE "Janela 1" ICON "images/cut.png" SIZE 640,480 OPACITY .5 OF oParent
...
STATIC FUNCTION ChildWindow2 (oParent)
   ...
   INIT WINDOW oWindow MDICHILD TITLE "Janela 2" ICON "images/copy.png" SIZE 640,480 OPACITY .5 OF oParent
...
STATIC FUNCTION ChildWindow3 (oParent)
   ...
   INIT WINDOW oWindow MDICHILD TITLE "Janela 3" ICON "images/paste.png" SIZE 640,480 OPACITY .5 OF oParent
