...
PROCEDURE Main ()
   ...
   PREPARE ACTION oActionA2 TEXT "Opção A2" ICON "images/open.png"  TOOLTIP "Executa a opção A2" ON TRIGGERED hwgqt_msginfo("A2") CHECKABLE OF oMainWindow
   ...
   PREPARE ACTION oActionB2 TEXT "Opção B2" ICON "images/copy.png"  TOOLTIP "Executa a opção B2" ON TRIGGERED hwgqt_msginfo("B2") CHECKABLE CHECKED OF oMainWindow
