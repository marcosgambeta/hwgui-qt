...
STATIC FUNCTION ChildWindow1 (oParent)
   ...
   INIT WINDOW oWindow TITLE "Janela 1" SIZE 640,480 MDICHILD OF oParent
...
STATIC FUNCTION ChildWindow2 (oParent)
   ...
   INIT WINDOW oWindow TITLE "Janela 2" SIZE 640,480 MDICHILD OF oParent
...
STATIC FUNCTION ChildWindow3 (oParent)
   ...
   INIT WINDOW oWindow TITLE "Janela 3" SIZE 640,480 MDICHILD OF oParent
