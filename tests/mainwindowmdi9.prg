...
PROCEDURE Main ()
   ...
   INIT WINDOW oMainWindow TITLE "Janela principal" SIZE 1024,768 MAIN MDI
...
STATIC FUNCTION ChildWindow1 (oParent)
   ...
   INIT WINDOW oWindow MDICHILD TITLE "Janela 1" SIZE 640,480 MAXIMUM SIZE 800,600 OF oParent
...
STATIC FUNCTION ChildWindow2 (oParent)
   ...
   INIT WINDOW oWindow MDICHILD TITLE "Janela 2" SIZE 640,480 MAXIMUM SIZE 800,600 OF oParent
...
STATIC FUNCTION ChildWindow3 (oParent)
   ...
   INIT WINDOW oWindow MDICHILD TITLE "Janela 3" SIZE 640,480 MAXIMUM SIZE 800,600 OF oParent
