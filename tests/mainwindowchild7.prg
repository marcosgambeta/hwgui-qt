...
STATIC FUNCTION ChildWindow1 (oParent)
   ...
   INIT WINDOW oWindow CHILD TITLE "Janela 1" SIZE 640,480 MAXIMUM SIZE 800,600 OF oParent
...
STATIC FUNCTION ChildWindow2 (oParent)
   ...
   INIT WINDOW oWindow CHILD TITLE "Janela 2" SIZE 640,480 MAXIMUM SIZE 800,600 OF oParent
...
STATIC FUNCTION ChildWindow3 (oParent)
   ...
   INIT WINDOW oWindow CHILD TITLE "Janela 3" SIZE 640,480 MAXIMUM SIZE 800,600 OF oParent
