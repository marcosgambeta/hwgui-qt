...
STATIC FUNCTION ChildWindow1 (oParent)
   ...
   INIT WINDOW oWindow MDICHILD TITLE "Janela 1" FIXED SIZE 640,480 OF oParent
...
STATIC FUNCTION ChildWindow2 (oParent)
   ...
   INIT WINDOW oWindow MDICHILD TITLE "Janela 2" FIXED SIZE 640,480 OF oParent
...
STATIC FUNCTION ChildWindow3 (oParent)
   ...
   INIT WINDOW oWindow MDICHILD TITLE "Janela 3" FIXED SIZE 640,480 OF oParent
