...
PROCEDURE Main ()
   ...
   // O arquivo actions2_resources.qrc é um arquivo XML.
   // Para gerar o arquivo actions2.rcc, use o comando abaixo:
   // rcc --binary actions2_resources.qrc --output actions2.rcc

   // Carrega o arquivo actions2.rcc, permitindo o uso de seus recursos na aplicação.
   // Para usar as imagens do arquivo de recursos, use o padrão abaixo:
   // ":images/new.png" (note o sinal de dois pontos no início da string)
