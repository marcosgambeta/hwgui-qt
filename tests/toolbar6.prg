...
PROCEDURE Main ()
   ...
   BEGIN TOOLBAR oToolBar2
      ...
      TOOLBARITEM "Save" ACTION hwgqt_MsgInfo("save-2") BITMAP "images/save.png"
      SEPARATOR
      TOOLBARITEM "Cut" ACTION hwgqt_MsgInfo("cut-2") BITMAP "images/cut.png"
      TOOLBARITEM "Copy" ACTION hwgqt_MsgInfo("copy-2") BITMAP "images/copy.png"
      TOOLBARITEM "Paste" ACTION hwgqt_MsgInfo("paste-2") BITMAP "images/paste.png"
   END TOOLBAR
