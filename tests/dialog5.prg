...
STATIC FUNCTION dialogmodal (oParent)
   ...
   INIT DIALOG oDialog TITLE "Janela de diálogo MODAL" AT 300,300 SIZE 320,240 OF oParent
...
STATIC FUNCTION dialognomodal (oParent)
   ...
   INIT DIALOG oDialog TITLE "Janela de diálogo NOMODAL" AT 300,300 SIZE 320,240 OF oParent
