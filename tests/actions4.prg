...
PROCEDURE Main ()
   ...
   PREPARE ACTION oActionA1 TEXT "Opção A1" ICON "images/new.png"   TOOLTIP "Executa a opção A1" ON TRIGGERED ( oActionA2:lEnabled := .T. ) OF oMainWindow
   PREPARE ACTION oActionA2 TEXT "Opção A2" ICON "images/open.png"  TOOLTIP "Executa a opção A2" ON TRIGGERED hwgqt_msginfo("A2") DISABLED OF oMainWindow
   ...
   PREPARE ACTION oActionB1 TEXT "Opção B1" ICON "images/cut.png"   TOOLTIP "Executa a opção B1" ON TRIGGERED ( oActionB2:lVisible := .T. ) OF oMainWindow
   PREPARE ACTION oActionB2 TEXT "Opção B2" ICON "images/copy.png"  TOOLTIP "Executa a opção B2" ON TRIGGERED hwgqt_msginfo("B2") INVISIBLE OF oMainWindow
