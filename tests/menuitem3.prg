      ...
      BEGIN MENU oMenuA TITLE "Menu A" OF oMenuBar
         ...
         BEGIN MENU oMenuA4 TITLE "Menu A4" OF oMenuA
            ...
            BEGIN MENU oMenuA41 TITLE "Menu A41" OF oMenuA4
               MENUITEM "Opção A411" ACTION hwg_MsgInfo("A411") OF oMenuA41
               MENUITEM "Opção A412" ACTION hwg_MsgInfo("A412") OF oMenuA41
               MENUITEM "Opção A413" ACTION hwg_MsgInfo("A413") OF oMenuA41
            END MENU
         END MENU
