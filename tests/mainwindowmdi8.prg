...
STATIC FUNCTION ChildWindow1 (oParent)
   ...
   INIT WINDOW oWindow MDICHILD TITLE "Janela 1" SIZE 640,480 MINIMUM SIZE 320,240 OF oParent
...
STATIC FUNCTION ChildWindow2 (oParent)
   ...
   INIT WINDOW oWindow MDICHILD TITLE "Janela 2" SIZE 640,480 MINIMUM SIZE 320,240 OF oParent
...
STATIC FUNCTION ChildWindow3 (oParent)
   ...
   INIT WINDOW oWindow MDICHILD TITLE "Janela 3" SIZE 640,480 MINIMUM SIZE 320,240 OF oParent
