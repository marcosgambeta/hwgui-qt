...
PROCEDURE Main ()
   ...
   // O arquivo actions3_resources.qrc é um arquivo XML.
   // Para gerar o arquivo actions3_resources.cpp, use o comando abaixo:
   // rcc actions3_resources.qrc --output actions3_resources.cpp

   // Compile o arquivo actions3.hbp e nao o arquivo actions3.prg:
   // compileqt4 actions3.hbp
   // ou
   // compileqt5 actions3.hbp

   // Os recursos estarão embutidos no executável, não precisando de
